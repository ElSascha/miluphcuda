...
#SBATCH --job-name=VonMises_impact_no_corr
...
# run the code
nice -15 ../build/bin/miluphcuda -v -A -f data/balls.0000 -g -H -k wendlandc4 -I rk2_adaptive -m materials/material_list.cfg -n 500 -M 0.001 -t 0.001 >> output.txt 2> error.txt