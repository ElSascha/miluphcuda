...
smoothing_length = np.full(npart, dx * 3.7) # Wendland c4 kernel support radius is 1.866 * dx for 3D, so this ensures that each particle has neighbors to interact with
