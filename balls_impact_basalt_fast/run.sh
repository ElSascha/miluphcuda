...
#SBATCH --job-name=Fast_Basalt_impact
...
# run the code
nice -15 ../build/bin/miluphcuda -v -A -f data/balls.0000 -g -H -k wendlandc4 -I rk2_adaptive -m materials/material_list.cfg -n 5000 -M 0.000001 -t 0.00005 >> output.txt 2> error.txt